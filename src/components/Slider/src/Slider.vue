...
export default {
	...
	props: {
		...
		theme: {
			type: String,
			default: 'default',
			validator: themeVal => ['default', 'hue'].includes(themeVal),
		},
	},
...
:root {
	...
	--slider-track-hue-border-color: rgba(0, 0, 0, 0.1);
	--slider-track-hue-height: 6px;
	--slider-track-hue-border-radius: 6px;
	...
	--slider-value-font-size: var(--form-small-font-size);
...
.Slider {
	...
	&.theme_hue {
		&::range-track {
			height: var(--slider-track-hue-height);
			border-radius: var(--slider-track-hue-border-radius);
			background: var(--slider-track-hue-background);
			box-shadow: inset 0 0 0 1px var(--slider-track-hue-border-color);
		}

		&::-webkit-slider-thumb {
			margin-top: calc((var(--slider-thumb-dimension) - var(--slider-track-hue-height)) / -2);
		}

		&::-ms-track {
			height: 4px;
			border: 1px solid var(--slider-track-hue-border-color);
			border-radius: 0;
			box-shadow: none;
		}
