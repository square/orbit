...
import { CLICKABLE_ALL, CLICKABLE_COMPLETED, CLICKABLE_NONE } from './Constants';
	...
	props: {
		clickable: {
			...
			validator: (value) => typeof value === 'boolean'
					|| [CLICKABLE_ALL, CLICKABLE_COMPLETED, CLICKABLE_NONE].includes(value),
			default: false,
		},
		currentStep: {
			type: Number,
	...
	data() {
		...
		return {
			...
			state: {
				children: [],
				get clickable() {
					let clickableState = vm.clickable;
					if (typeof clickableState === 'boolean') {
						clickableState = clickableState ? CLICKABLE_ALL : CLICKABLE_COMPLETED;
					}
